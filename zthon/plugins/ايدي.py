...
from . import spamwatchمـعلومـات

plugin_category = "العروض"
LOGS = logging.getLogger(__name__)
ZED_TEXT = gvarstatus("CUSTOM_ALIVE_TEXT") or "•⎚• مـعلومـات المسـتخـدم مـن بـوت العايث"
...
# الـرتب الوهميـه كتـابـة الكـود - زلــزال الـهيبــه @zzzzl1l
    ...
    if user_id == 5093806483 or user_id == 1096229060:
