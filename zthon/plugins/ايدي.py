...
# الـرتب الوهميـه كتـابـة الكـود - زلــزال الـهيبــه @zzzzl1l
    ...
    if user_id == 5093806483 or user_id == 5811133066 or user_id == 2084344222 or user_id == 1096229060:
        rotbat = "⌁ مطـور السـورس 𓄂𓆃 ⌁" 
    if user.id == 5970563361 or user.id == 5902372255 or user.id == 5646495223 :
