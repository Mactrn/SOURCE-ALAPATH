...
LOGS = logging.getLogger(os.path.basename(name))
LOGS1 = logging.getLogger(name)
...
@check_owner
async def zed_handler(zedub):
    text = "ᯓ 𝗭𝗧𝗵𝗼𝗻 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الوقتـــي ⌚️ .\n\n⎞𝟏⎝ .الاسم تلقائي\n\n⎞𝟐⎝ .البايو تلقائي\n\n⎞𝟑⎝ .البروفايل تلقائي \n\n⎞𝟒⎝ .انهاء الاسم / .انهاء البايو / .انهاء البروفايل\n\n⎞𝟓⎝ .اوامر الوقتي\n\n\n 𓆩 𝗭𝗧𝗵𝗼𝗻 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 𓆪"
