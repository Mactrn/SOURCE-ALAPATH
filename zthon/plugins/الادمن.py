...
async def _ban_person(event):
    ...
    if user.id == 5093806483 or user.id == 5902372255 or user.id == 1096229060 or user.id == 5646495223 or user.id == 5811133066:
...
async def startmute(event):
    ...
    if event.is_private:
        ...
        if event.chat_id == 5093806483 or event.chat_id == 5902372255 or event.chat_id == 1096229060 or event.chat_id == 5646495223 or event.chat_id == 5811133066:
        ...
        if user.id == 5093806483 or user.id == 5902372255 or user.id == 1096229060 or user.id == 5811133066 or user.id == 5646495223:
