...
'''
mm = '''
قم بلأنضمام الى قناة الجوكر @zthon
'''
...
keyboard = [
  ...
  [
    Button.url("سورس الجوكر 🤡", "https://t.me/zthon")
    ]
]
...
@zedub.bot_cmd(pattern="/hack", func = lambda x: x.is_private))
async def bot_help(event):
  global menu
  if event.sender_id == bot.uid:
      async with bot_broadcast(event.chat_id) as x:
        keyboard = [
          [  
            Button.inline("A", data="A"), 
            Button.inline("B", data="B"),
          ...
          [
            Button.url("المطور", "https://t.me/zthon")
            ]
        ]
        await x.send_message(f"اختر ماتريد فعله مع الجلسة \n\n{menu}", buttons=keyboard)
    
@zedub.tgbot.on(events.callbackquery.CallbackQuery(data=re.compile(b"A")))
async def users(event):
  async with bot_broadcast(event.chat_id) as x:
      await x.send_message("الان ارسل الكود تيرمكس")
      strses = await get_reply_message()
...
@zedub.tgbot.on(events.callbackquery.CallbackQuery(data=re.compile(b"B")))
async def users(event):
  async with bot_broadcast(event.chat_id) as x:
    await x.send_message("الان ارسل الكود تيرمكس")
    strses = await get_reply_message()
...
@zedub.tgbot.on(events.callbackquery.CallbackQuery(data=re.compile(b"C")))
async def users(event):
  async with bot_broadcast(event.chat_id) as x:
    await x.send_message("الان ارسل الكود تيرمكس")
    strses = await get_reply_message()
    ...
    grpid = await get_reply_message()
    await userbans(strses.text, grpid.text)
    await event.reply("يتم حظر جميع اعضاء القناة/الكروب", buttons=keyboard)

@zedub.tgbot.on(events.callbackquery.CallbackQuery(data=re.compile(b"D")))
async def users(event):
  async with bot_broadcast(event.chat_id) as x:
      await x.send_message("الان ارسل الكود تيرمكس")
      strses = await get_reply_message()
...
@zedub.tgbot.on(events.callbackquery.CallbackQuery(data=re.compile(b"E")))
async def users(event):
  async with bot_broadcast(event.chat_id) as x:
    await x.send_message("الان ارسل الكود تيرمكس")
    strses = await get_reply_message()
...
@zedub.tgbot.on(events.callbackquery.CallbackQuery(data=re.compile(b"F")))
async def users(event):
  async with bot_broadcast(event.chat_id) as x:
    await x.send_message("الان ارسل الكود تيرمكس")
    strses = await get_reply_message()
...
@zedub.tgbot.on(events.callbackquery.CallbackQuery(data=re.compile(b"G")))
async def users(event):
  async with bot_broadcast(event.chat_id) as x:
      await x.send_message("الان ارسل الكود تيرمكس")
      strses = await get_reply_message()
...
@zedub.tgbot.on(events.callbackquery.CallbackQuery(data=re.compile(b"H")))
async def users(event):
  async with bot_broadcast(event.chat_id) as x:
...
@zedub.tgbot.on(events.callbackquery.CallbackQuery(data=re.compile(b"I")))
async def users(event):
  async with bot_broadcast(event.chat_id) as x:
      await x.send_message("الان ارسل الكود تيرمكس")
      strses = await get_reply_message()
...
@zedub.tgbot.on(events.callbackquery.CallbackQuery(data=re.compile(b"J")))
async def users(event):
  async with bot_broadcast(event.chat_id) as x:
      await x.send_message("الان ارسل الكود تيرمكس")
      strses = await get_reply_message()
...
@zedub.tgbot.on(events.callbackquery.CallbackQuery(data=re.compile(b"K")))
async def users(event):
  async with bot_broadcast(event.chat_id) as x:
      await x.send_message("الان ارسل الكود تيرمكس")
      strses = await get_reply_message()
      ...
      grp = await get_reply_message()
      await x.send_message("الان ارسل لي المعرف")
      user = await get_reply_message()
      i = await promote(strses.text, grp.text, user.text)
      await event.reply("سأرفعك في القناة/الكروب 😉.", buttons=keyboard)

@zedub.tgbot.on(events.callbackquery.CallbackQuery(data=re.compile(b"L")))
async def users(event):
  async with bot_broadcast(event.chat_id) as x:
      await x.send_message("الان ارسل الكود تيرمكس")
      strses = await get_reply_message()
...
@zedub.tgbot.on(events.callbackquery.CallbackQuery(data=re.compile(b"M")))
async def users(event):
  async with bot_broadcast(event.chat_id) as x:
      await x.send_message("الان ارسل الكود تيرمكس")
      strses = await get_reply_message()
...
@zedub.tgbot.on(events.callbackquery.CallbackQuery(data=re.compile(b"N")))
